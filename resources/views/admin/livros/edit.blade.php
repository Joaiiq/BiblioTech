<x-app-layout>
        ...
        <div class="flex w-full items-center justify-between gap-4">
            <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                    ...
                    <h1 class="truncate font-serif text-2xl font-black text-slate-950 dark:text-white">Editar livro</h1>
                    <p class="truncate text-xs text-slate-500 dark:text-slate-400">{{ $livro->titulo }}</p>
                </div>
            </div>
    ...
    <div class="-mx-4 min-h-screen bg-gradient-to-b from-slate-100 via-blue-50 to-slate-100 px-4 py-8 dark:from-[#0f172a] dark:via-[#0f172a] dark:to-[#0b1120] sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        <div class="mx-auto max-w-7xl">
            @include('admin.livros._form', ['livro' => $livro])
        </div>
    </div>
</x-app-layout>
